...
$p(5)  = C(4,0) * p(4) + C(4,1) * p(3) + C(4,2) * p(2) + C(4,3) * p(1) + C(4,4) * p(0) = 1 * 15 + 4 * 5 + 6 * 2 + 4 * 1 + 1 * 1 = 52$ </br>
$p(6)  = C(5,0) * p(5) + C(5,1) * p(4) + C(5,2) * p(3) + C(5,3) * p(2) + C(5,4) * p(1) + C(5,5) * p(0) = 1 * 52 + 5 * 15 + 10 * 5 + 10 * 2 + 5 * 1 + 1 * 1 = 203$ </br>
$p(7)  = C(6,0) * p(6) + C(6,1) * p(5) + C(6,2) * p(4) + C(6,3) * p(3) + C(6,4) * p(2) + C(6,5) * p(1) + C(6,6) * p(0) = 1 * 203 + 6 * 52 + 15 * 15 + 20 * 5 + 15 * 2 + 6 * 1 + 1 * 1 = 877$ </br>
$p(8)  = C(7,0) * p(7) + C(7,1) * p(6) + C(7,2) * p(5) + C(7,3) * p(4) + C(7,4) * p(3) + C(7,5) * p(2) + C(7,6) * p(1) + C(7,7) * p(0) = 1 * 877 + 7 * 203 + 21 * 52 + 35 * 15 + 35 * 5 + 21 * 2 + 7 * 1 + 1 * 1 = 4140</br>
$p(9)  = C(8,0) * p(8) + C(8,1) * p(7) + C(8,2) * p(6) + C(8,3) * p(5) + C(8,4) * p(4) + C(8,5) * p(3) + C(8,6) * p(2) + C(8,7) * p(1) + C(8,8) * p(0) = 1 * 4140 + 8 * 877 + 28 * 203 + 56 * 52 + 70 * 15 + 56 * 5 + 28 * 2 + 8 * 1 + 1 * 1  = 21147$ </br>
$p(10) = C(9,0) * p(9) + C(9,1) * p(8) + C(9,2) * p(7) + C(9,3) * p(6) + C(9,4) * p(5) + C(9,5) * p(4) + C(9,6) * p(3) + C(9,7) * p(2) + C(9,8) * p(1) + C(9,9) * p(0) =  1 * 21147 + 9 * 4140 + 36 * 877 + 84 * 203 + 126 * 52 + 126 * 15 + 84 * 5 + 36 * 2 + 9 * 1 + 1 * 1 = 115975$ </br>
