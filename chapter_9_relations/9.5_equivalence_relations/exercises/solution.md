...
$p(0)  = 1$ </br>
$p(1)  = C(0,0) * p(0) = 1 * 1 = 1$ </br>
$p(2)  = C(1,0) * p(1) + C(1,1) * p(0) = 1 * 1 + 1 * 1 = 2$ </br>
$p(3)  = C(2,0) * p(2) + C(2,1) * p(1) + C(2,2) * p(0) = 1 * 2 + 2 * 1 + 1 * 1 = 5$ </br>
$p(4)  = C(3,0) * p(3) + C(3,1) * p(2) + C(3,2) * p(1) + C(3,3) * p(0) = 1 * 5 + 3 * 2 + 3 * 1 + 1 * 1 = 15$ </br>
